...
servers:
  ...
  - url: https://api.skribble.de
    description: Production - Germany
  - url: https://api.scribital.com
    description: Staging - Switzerland
  - url: https://api.scribital.de
...
paths:
  /v2/access/login:
    post:
      tags:
        - 🔑 Authentication
      summary: Login as user "api_demo_your_name"
      description: >-
        ...
        Upon a successful login, a JSON Web Token (JWT) will be returned (see
        `{{AUTH_ACCESS_TOKEN}}`).  

        The JWT MUST be included in nearly every request made to the API.


        The access token is transported in an HTTP header called
        `Authorization`.


        The content of the header starts with `Bearer` followed by the JWT
        string.


        Example: `Authorization: {{vault:bearer-token}}`
        ...
        * * *
        ...
        The validity period should depend on the volume of API calls and will be
        discussed individually for each customer as part of the shared secret
        agreement.
        ...
        Currently, we do not renew the access token automatically. But this is
        ...
        There is **no logout**. The access token will expire after the defined
        time.
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              allOf:
                - $ref: '#/components/schemas/Loginasuserapi_demo_your_nameRequest'
                - examples:
          ...
          content:
            text/plain:
              schema:
                ...
                examples:
                  - >-
                    eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJJWlMxY0pXQXlXVFdZeDR6dXRGNzJlYWVILTA0MUprTDF5N2Z3aXA1T3UwIn0Ei3Hm3rhjOAq5dWo6Z0l6bzvyGCXd87oRoOWDM2sW4KErCKYmcQ6ks8FVj3Fn8wXNIVAnp5ClZvWNw9Uks1zM9P2IXBbBPn7DIQGvM
                    ...
          ...
          content:
            text/plain:
              schema:
                type: string
                examples:
                  - Please ensure your username and api-key are correct!
                contentMediaType: text/plain
              example: Please ensure your username and api-key are correct!
        default:
          description: ''
          headers: {}
          content:
  ...
  /v2/signature-requests:
    post:
      ...
      description: >-
        ...
        signature requests in which you are the only signer or where you are not
        a signer yourself. In the second case, you as creator of the
        ...
        content:
          application/json:
            schema:
              allOf:
                - $ref: >-
                    #/components/schemas/CreateasimplesignaturerequestforaPDFdocument
                - examples:
          ...
          content:
            application/json:
              schema:
                allOf:
                  - $ref: >-
                      #/components/schemas/Createasignaturerequestforthreesigners200
                  - examples:
    ...
    get:
      ...
      description: >-
        Using this `GET` request, you can list all the `SignatureRequests`
        provided that the current user has sufficient access rights to.


        You can optionally filter these `SignatureRequests` using one or more of
        ...
        | **account_email** | Filter on the field `signatures[].account_email` |
        no |

        | **search** | Filter on the field `title` to search for documents
        _**containing**_ the serach term. | no |

        | **signature_status** | Filter on the field `signatures[].status_code`
        with one of the valid **Signature states** | no |

        | **status_overall** | Filter on the field `status_overall` with one of
        the valid **Signature states** | no |


        > **Note**  

        The filter searches for an exact match of the corresponding field
        content. This means that the filter is case sensitive and won&apos;t
        find objects that only _contain_ the parameter. For example
        _account_email=john.doe@skribble.com_ will only find a
        `SignatureRequests` where the field `account_email` is exactly
        ...
        Exception: The search parameter searches for document titles that
        ...
        **Pagination**
        ...
        Furthermore, the result set can be controlled using the optional
        pagination parameters `page_number` and `page_size`, which helps prevent
        ...
        | `page_size` | Page size must be greater than or equal to 0 
        <br>Default: 50 | no |
    ...
    put:
      ...
      description: >-
        ...
        - To add a signer to the `SignatureRequest`, simply add a new entry to
        ...
        - Please be aware that if you want to add one or more new signers, you
        MUST include the existing signers in the update request. Any signers not
        present in the `signatures` array will be removed!
            
        - Changes to the signatures can only be made as long as none of the
        signers have already completed the signature.
        ...
        content:
          application/json:
            schema:
              allOf:
                - $ref: >-
                    #/components/schemas/AddorremovemultiplesignerssimultaneouslyRequest
                - examples:
                    - id: '{{SR_ID}}'
                      title: NewTitleTest
                      signatures:
  ...
  /0000...2222:
    get:
      ...
      summary: Exit point example
      description: >-
        In this example we redirect the user to *https://www.google.com* and
        wait for max. 20 seconds to fullfil this request.
      operationId: Exitpointexample
      parameters:
        - name: exitURL
          in: query
          description: ''
          ...
          content:
            text/plain:
              schema:
                type: string
                examples:
                  - 'No response: You will be redirected to http://www.google.com'
                contentMediaType: text/plain
              example: 'No response: You will be redirected to http://www.google.com'
      deprecated: false
      servers:
        - url: https://my.skribble.com/view
          variables: {}
    parameters: []
  /v2/signature-requests/{SR_ID}:
    get:
      tags:
        - 3. Download the signed PDF document
      summary: Get the document ID from the signature request
      description: >-
        We distinguish between the signature request ID and document ID. To read
        and download the PDF document, the document ID is retrieved from the 
        `SignatureRequest` with the ID `{{SR_ID}}`
      operationId: GetthedocumentIDfromthesignaturerequest
      parameters:
        - name: SR_ID
          in: path
          description: ''
              ...
              content:
                text/plain:
                  schema:
                    type: string
                    contentMediaType: text/plain
                  example: Thu, 05 Nov 2020 14:52:08 GMT
          content:
            application/json;charset=UTF-8:
              schema:
                allOf:
                  - $ref: >-
                      #/components/schemas/GetthedocumentIDfromamissingsignaturerequest4041
                  - examples:
                      - type: https://api.skribble.com/problem/entity-not-found
                        ...
                        method: GET
                        path: >-
                          /v2/signature-requests/000000-2423-2323-cccc-00000000000
    ...
    delete:
      ...
      description: >-
        ...
        **Important:** A `SignatureRequest` can only be deleted using the API,
        if:

        1. the `SignatureRequest` is in the `status_overall=OPEN` and

        2. the API user has sufficient rights on the `SignatureRequest`, eg.
        ...
        **WITHDRAWN**  
        ...
        This means that the `SignatureRequest` will get
        `status_overall=WITHDRAWN` and all the invited signatures will be marked
        with `status_code=WITHDRAWN`. Sign and read rights for the signers will
        be removed from the `SignatureRequest`, so that the invited signers can
        neither read nor sign the `SignatureRequest` any more. 


        **REMOVE AS PARTICIPANT**  

        When the API user is NOT the owner of the document but a participant of
        the `SignatureRequest`, then the `DELETE` request will only remove the
        current API user as participant from the signature request. 

        In this case the system will remove the objects the `SignatureRequest`
        and the related `document` as soon as the last remaining user deletes
        the `SignatureRequest` using the [Skribble web
        ...
        **DELETING**  
        ...
        from the system.
      operationId: Deleteasignaturerequest
      parameters:
        - name: SR_ID
          in: path
          description: ''
  ...
  /v2/documents/{DOC_ID}/content:
    get:
      tags:
        - 3. Download the signed PDF document
      summary: Download the PDF document
      description: >-
        Now you can download the document content that contains the PDF document
        with the document ID `{{DOC_ID}}`. 
      operationId: DownloadthePDFdocument
      parameters:
        - name: DOC_ID
          in: path
          description: ''
  ...
  /v2/sendto/{SEND_TO_ID}/track:
    get:
      tags:
        - Find
      summary: Track Send-To object - Check for status
      description: >-
        ...
        | `status` | Describes the status of the `Send-To` request. 
        <br>Possible status values are:  <br>\- `UNCLAIMED`  <br>\- `EXPIRED` 
        <br>\- `CLAIMED`  <br>\- `SIGNING`  <br>\- `SIGNED`  <br>\- `WITHDRAWN` 
        <br>\- `DECLINED` | `CLAIMED` |

        | `signers` | List of signers. | signer@skribble.com |

        | `creator` | User who claimed the Send-To request. |  |
      operationId: TrackSend-Toobject-Checkforstatus
      parameters:
        - name: X-Accesscode
          in: header
          description: ''
        ...
        '200':
          ...
          content:
            application/json:
              schema:
                allOf:
                  - $ref: '#/components/schemas/TrackSend-Toobject-Checkforstatus'
                  - examples:
                      - status: UNCLAIMED
                        signers: null
                        creator: null
  ...
  /sendto/{SEND_TO_ID}/download:
    get:
      tags:
        - Find
      summary: Download Send-To based document
      description: >-
        ...
        As response you will get the initially provided PDF document in its
        current state. This might be signed, declined or withdrawn or still open
        for signing. The status can be obtained using the `track` endpoind.
      operationId: DownloadSend-Tobaseddocument
      parameters:
        - name: X-Accesscode
          in: header
          description: ''
  ...
  /v2/documents:
    get:
      ...
      operationId: Listallaccessibledocuments
      parameters: []
      responses:
        default:
          description: ''
    ...
    post:
      tags:
        - Create
      summary: Simple PDF document upload
      description: >-
        A simple PDF document upload using a **Base64 encoded** file as
        `content`.
      operationId: SimplePDFdocumentupload
      parameters: []
      requestBody:
        description: ''
        content:
          application/json:
            schema:
              allOf:
                - $ref: '#/components/schemas/SimplePDFdocumentuploadRequest'
                - examples:
        ...
        default:
          ...
          content:
            application/json:
              schema:
                allOf:
                  - $ref: '#/components/schemas/SimplePDFdocumentupload200'
                  - examples:
            ...
            text/plain:
              schema:
                ...
                contentMediaType: text/plain
              example: Neither 'content' nor 'file_url' provided
      deprecated: false
      security:
        - bearer: []
      servers:
  ...
  /v2/documents/{DOC_ID}:
    get:
      ...
      description: >-
        To query one single `Documents` object, you can pass the document ID
        `{{DOC_ID}}` with this request. The `Documents` object contains document
        metadata such as `title`, `owner`, `size` and useful page information.
      operationId: Getthedocumentmetadata
      parameters:
        - name: DOC_ID
          in: path
          description: ''
    ...
    delete:
      ...
      description: >-
        ...
        If there is MORE than one participant involved, then the DELETE request
        will only remove the current user from the `Document`.   


        Only when the lat user deletes the `Document` using the Skribble web
        application, the system  will finally remove the object.
      operationId: Deletethedocument
      parameters:
        - name: DOC_ID
          in: path
          description: ''
  ...
  /v2/documents/{DOC_ID}/pages/{PAGE_ID}:
    get:
      tags:
        - Find
      summary: Get the document page preview
      description: >-
        When uploading a PDF document to Skribble, the system generates some
        preview images for the PDF pages. These preview images can be requested
        by passing the page `{{PAGE_ID}}` you want to get a preview for,
        starting at **0** for page number 1.  


        > By using the optional parameter `scale` you can choose between a
        preview in real size using `scale=100` or a thumbnail preview using
        `scale=20`.   
      operationId: Getthedocumentpagepreview
      parameters:
        - name: DOC_ID
          in: path
          description: ''
          ...
          content:
            'image/webp or image/png ':
              schema:
                ...
                examples:
                  - >-
                    Image as raw bytes in WEBP format or PNG for older
                    documemnts. See Content-Type.
                contentMediaType: 'image/webp or image/png '
              example: >-
                Image as raw bytes in WEBP format or PNG for older documemnts.
                See Content-Type.
        default:
          description: ''
          headers: {}
  ...
  /v2/signature-requests/{SR_ID}/signatures:
    post:
      ...
      description: >-
        ...
        SignatureRequest. The process is the same. By using `account_email`, you
        can add a signer who has a Skribble account. By using
        `signer_identity_data`, you can invite a No-Account-Signer to the
        SignatureRequest with the ID `{{SR_ID}}`.
        ...
        account. The benefit is that an existing Skribble user will afterwards
        find the SignatureRequest in the **To sign** section of their account on
        my.skribble.com.  
        ...
        existing Skribble account. Instead, they will have to access the
        document using the specific link provided in their signature invitation
        email.
      operationId: Addanindividualsigner
      parameters:
        - name: SR_ID
          in: path
          description: ''
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              allOf:
                - $ref: '#/components/schemas/AddanindividualsignerRequest'
                - examples:
  ...
  /v2/signature-requests/{SR_ID}/signatures/{SID}:
    delete:
      tags:
        - Add or remove signers
      summary: Remove an individual signer
      description: >-
        To remove an individual signer, provide the SignatureRequest ID
        `{{SR_ID}}` and the Signature ID `{{SID}}` of the signer you want to
        remove.
      operationId: Removeanindividualsigner
      parameters:
        - name: SR_ID
          in: path
          description: ''
        ...
        content:
          application/json:
            schema:
              allOf:
                - $ref: >-
                    #/components/schemas/AddanattachmenttoasignaturerequestRequest
                - examples:
        ...
        default:
          ...
          content:
            application/json:
              schema:
                allOf:
                  - $ref: '#/components/schemas/Addaunsupportedattachmenttype'
                  - examples:
  ...
  /v2/signature-requests/{SR_ID}/attachments/{ATTACHMENT_ID}/content:
    get:
      tags:
        - Add or remove attachments
      summary: Download a specific attached file from a signature request
      description: >-
        Downloads the attachment content with the `ATTACHMENT_ID` for the
        `SignatureRequest` with the ID `SR_ID`
      operationId: Downloadaspecificattachedfilefromsignaturerequest
      parameters:
        - name: SR_ID
          in: path
          description: ''
  ...
  /v2/signature-requests/{SR_ID}/attachments/{ATTACHMENT_ID}:
    delete:
      tags:
        - Add or remove attachments
      summary: Remove an attachment from a signature request
      description: >-
        Delete the attachment with the `ATTACHMENT_ID` from the
        `SignatureRequest` with the ID `SR_ID`
      operationId: Removeanattachmentfromasignaturerequest
      parameters:
        - name: SR_ID
          in: path
          description: ''
  ...
  /v2/signature-requests/{SR_ID}/withdraw:
    post:
      tags:
        - Modify
      summary: Withdraw a signature request
      description: >-
        Sometimes, signing a document may become unnecessary, or errors might
        occur during the invitation process. As the inviter of such a
        `SignatureRequest`, you can _explicitely_ `withdraw` the
        `SignatureRequest`. Withdraw removes all signatories and observers from
        the document as participants and notifies them with a specified
        `message.`
        ...
        We recommend using the `delete` endpoint. By default, it checks for
        other options. For example, if the API user does not have withdrawal
        rights, the user could be removed from the `SignatureRequest` directly,
        or the document might be deleted directly.  

        Nevertheless, there may be situations in which you need to withdraw the
        document and keep it in Skribble. In this case you should of course use
        the `withdraw` functionality.
      operationId: Withdrawasignaturerequest
      parameters:
        - name: SR_ID
          in: path
          description: ''
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              allOf:
                - $ref: '#/components/schemas/WithdrawasignaturerequestRequest'
                - examples:
  ...
  /v2/sendto/{SEND_TO_ID}:
    delete:
      tags:
        - Modify
      summary: Delete Send-To object
      description: >-
        To `delete` a `Sent-To` object based on its `ID` you must include the
        value of the `access_code` field—received when creating the `Send-To`
        object—in the request header `X-Accesscode`.


        This call deletes the involved `Send-To,` `Document` and
        `SignatureRequest` objects regardeless the current `Send-To` state.
      operationId: DeleteSend-Toobject
      parameters:
        - name: X-Accesscode
          in: header
          description: ''
  ...
  /v2/signature-requests/{SR_ID}/remind:
    post:
      tags:
        - Triggers
      summary: Remind open signers of a signature request
      description: >-
        In addition to the automatic signature reminders, manual reminders can
        also be initiated via the Skribble web application and also via the API.


        This allows for greater flexibility in managing signature requests,
        ensuring that important documents are signed promptly. By using both
        automatic and manual reminders, you can tailor your approach to suit the
        specific needs of your users or customers.


        **Limits**


        There is an hourly limit on the number of signature reminders that can
        be sent. This limit ensures that reminders are used responsibly and
        prevents excessive notifications. Generally, this restriction should not
        affect you if you use this feature appropriately. By adhering to this
        limit, you can effectively manage your signature requests without
        overwhelming your users or customers with frequent reminders.
      operationId: Remindopensignersofasignaturerequest
      parameters:
        - name: SR_ID
          in: path
          description: ''
  ...
  /v2/seal:
    post:
      ...
      description: >-
        In this example  we seal the document with a visual signature including
        an image. This represents the visual seal of the company.
      operationId: Sealadocument
      parameters: []
      requestBody:
        description: ''
        content:
          application/json:
            schema:
              allOf:
                - $ref: '#/components/schemas/SealadocumentRequest'
                - examples:
                    - content: '{{BASE64_PDF}}'
                      visual_signature:
                        position:
        ...
        default:
          ...
          content:
            application/json:
              schema:
                allOf:
                  - $ref: '#/components/schemas/Sealadocument200'
                  - examples:
  ...
  /v2/sendto:
    post:
      ...
      description: >-
        ...
        > Sign-To objects and its related Documents and SignatureRequests are
        only guaranteed for a **limited lifetime.** 
          

        - Sign-To request that dont get claimed by a user, so where a user does
        not add the document to the list of his documents to sign, will be
        deleted automatically after one day.
            
        - Sign-To objects and its related Documents and SignatureRequest objects
        in general, independant of its status, will be deleted automatically
        after 90 days.
      operationId: CreateSend-Toobject
      parameters: []
      requestBody:
        description: ''
        content:
          application/json:
            schema:
              allOf:
                - $ref: '#/components/schemas/CreateSend-ToobjectRequest'
                - examples:
        ...
        '200':
              ...
              content:
                text/plain:
                  schema:
                    type: string
                    contentMediaType: text/plain
                  example: Tue, 04 Mar 2025 08:27:30 GMT
            Transfer-Encoding:
              content:
                text/plain:
                  schema:
          ...
          content:
            application/json;charset=UTF-8:
              schema:
                allOf:
                  - $ref: '#/components/schemas/CreateSend-Toobject'
                  - examples:
                      - url: >-
                          https://my.skribble.com/sendto/1d2e74c7-92d6-d552-66c6-dd9e640000c9
  ...
  /signature-qualities-detail:
    get:
      tags:
        - User
      summary: Get signature qualities details for a user
      description: >-
        The result of this query will tell you what final signature quality will
        be used for the given user username to sign a document.  

        The resulting signature quality is determined in combination of the
        requested quality and legislation, whereas any stands for any
        legislation.  

        Description for the example request:  

        If you create a SignatureRequest with quality=AES_MINIMAL and the
        legislation=ZERTES the user in this example would finally sign the
        document with the signature quality QES.  

        As described in the previous chapter AES_MINIMAL will use QES as long as
        the user settings allow this.
      operationId: Getsignaturequalitiesdetailsforauser
      parameters:
        - name: username
          in: query
          description: ''
  ...
  /v2/user/signature-qualities:
    get:
      ...
      description: >-
        ...
        detailed signature quality information for a user. This endpoint
        provides comprehensive data about the quality of the signature. However,
        for compatibility reasons, we continue to offer the previous endpoint,
        which delivers a simplified result set. This ensures that users of the
        older version of our API can still access essential signature quality
        information without needing to upgrade immediately.
        ...
        '200':
          ...
          content:
            application/json:
              schema:
                allOf:
                  - $ref: '#/components/schemas/Getauserssignaturequalities'
                  - examples:
                      - qes:
                          zertes: QES
                          eidas: QES
  ...
  /v2/activities/signatures:
    get:
      tags:
        - Report
      summary: Get signature activities by business
      description: >-
        This endpoint provides detailled signature `activities` information for
        your business and your members within a specified date range.
        ...
        | `start_date` | The start date of the range to fetch the signature
        `activities`.  <br>Format: `yyyy-MM-dd.` | yes |

        | `end_date` | The end date of the range to fetch the signature
        `activities`.  <br>Format: `yyyy-MM-dd.` | yes |
        ...
        The result set can be controlled using the optional pagination
        ...
        | `page` | The page number to fetch the signature `activities`. 
        <br>Must be a positive integer.  <br>Default: 1 | no |

        | `size` | The size of the page to fetch the signature activities. 
        <br>Must be a positive integer.  <br>Default: 25  <br>Maximum: 100 | no
        |

        | `sort` | The sort order of the signature activities. Can be `asc` or
        `desc`.  <br>Default is `desc`. | yes |
        ...
        **General**
        ...
        | `activities` | Array of `activities`. See the following subchapter
        _Activities_. |

        | `total_items` | Total items to fetch when paginating through all the
        pages. |

        | `total_pages` | Total pages to fetch when paginating through all the
        pages. |
        ...
        **Activities**
        ...
        | `action` | The action type of a signature activity. |
        ...
        | `business_id_paid_by` | The ID of the business that paid for the
        signature activity. |

        | `cost_center` | The cost center of the signature paying party. |

        | This information might not necessarily be present. |  |

        | `initiator` | The initiator `user` of the signature `activity`. See
        the following subchapter _User_. |

        | `signer` | The signer `user` of the signature `activity`. See the
        following subchapter _User_. |
        ...
        **User**
        ...
        | `type` | The membership status of the `user` in relation to the
        business. Can be `api`, `external`, `member` or `unknown`. |

        | `mobile` | The mobile number of the user. |
      operationId: Getsignatureactivitiesbybusiness
      parameters:
        - name: start_date
          in: query
          description: ''
  ...
  /v2/signature-requests/{SR_ID}/callbacks:
    get:
      ...
      description: >-
        ...
        callbacks for a `SignatureRequest`. For example, you might want to
        confirm whether a callback has already been executed or to identify any
        errors that occurred during the callback process.


        This endpoint provides the capability to obtain detailed information
        about the callbacks associated with a `SignatureRequest`, enabling
        comprehensive monitoring and troubleshooting. By using this endpoint,
        you can ensure the reliability and accuracy of your callback operations
        ...
        **Result**
        ...
        Otherwise it will contain an array of `callback` objects that were
        already executed.
        ...
        | `signature_request_id` | The ID of the parent `SignatureRequest`
        object. |

        | `url` | The given URL to which the callback request will be sent. |

        | `type` | The type of the event the callback is executed on. This field
        can have the value `SUCCESS`, `UPDATE` or `ERROR` based on the given
        `SignatureRequest` fields `callback_success_url`, `callback_update_url`
        and `callback_error_url` |

        | `state` | The state of the callback. This field can be:  <br>`OPEN` -
        The callback request will be executed in the next execution cycle. 
        <br>`COMPLETED` - The callback request was executed successfully. The
        API received an HTTP 2xx success code in response.  <br>`RESIGNATED` -
        The callback request has been attempted `attempts` times but was
        unsuccessful. The API did not receive a valid HTTP 2xx response. |

        | `attempts` | The amount of times the callback request was executed. |

        | `messages` | An array of messages containing the HTTP response message
        in case that the API did not receive a HTTP 2xx success code. |
          ...
          content:
            application/json:
              schema:
                ...
                items:
                  $ref: >-
                    #/components/schemas/Getthelistofcallbacksforasignaturerequest
                description: ''
                examples:
        ...
        default:
          ...
          content:
            application/json:
              schema:
                allOf:
                  - $ref: '#/components/schemas/Systemhealth200'
                  - examples:
                      - status: UP
                contentMediaType: application/json
              example:
  ...
  /:
    get:
      tags:
        - Appendix
      summary: Example PDF (Base64)
      description: >-
        This is a base64 encoded one page PDF, ready to be used in the
        **Skribble API Quickstart** examples.  

        Please copy this directly into your requests or add an environment
        variable for this.
      operationId: ExamplePDF(Base64)
      parameters: []
      responses:
        default:
          description: ''
...
components:
  securitySchemes:
    bearer:
      ...
      scheme: bearer
  schemas:
    Loginasuserapi_demo_your_nameRequest:
      title: Loginasuserapi_demo_your_nameRequest
      required:
        - username
        - api-key
      type: object
    ...
    Signature:
      ...
      examples:
        - account_email: you@example.info
    AddorremovemultiplesignerssimultaneouslyRequest:
      title: AddorremovemultiplesignerssimultaneouslyRequest
      required:
        - id
        - title
        - signatures
      ...
      examples:
        - id: '{{SR_ID}}'
          ...
          signatures:
            - account_email: john.doe@skribble.com
            - account_email: new.signer@skribble.com.org
    CreateasimplesignaturerequestforaPDFdocument:
      title: CreateasimplesignaturerequestforaPDFdocument
      required:
        - title
        - message
        - content
    ...
    Signature1:
      ...
      examples:
        - sid: eeeeeeee-cdab-938a-aed9-ebabbc92a013
          ...
          status_code: OPEN
          notify: true
    Createasignaturerequestforthreesigners200:
      title: Createasignaturerequestforthreesigners200
      required:
        - id
        - title
        - message
      ...
      examples:
        - id: cccccccc-4a6a-a958-a42e-6ea4172a378b
          ...
          created_at: '2099-12-12T12:12:12.000Z'
          updated_at: '2099-12-12T12:12:12.000Z'
    GetthedocumentIDfromamissingsignaturerequest4041:
      title: GetthedocumentIDfromamissingsignaturerequest4041
      required:
        - type
        - status
        - message
      ...
      examples:
        - type: https://api.skribble.com/problem/entity-not-found
          ...
          method: GET
          path: /v2/signature-requests/000000-2423-2323-cccc-00000000000
    TrackSend-Toobject-Checkforstatus:
      title: TrackSend-Toobject-Checkforstatus
      required:
        - status
        - signers
        - creator
      ...
      examples:
        - status: UNCLAIMED
          signers: null
          creator: null
    SimplePDFdocumentuploadRequest:
      title: SimplePDFdocumentuploadRequest
      required:
        - title
        - content
      type: object
      ...
      examples:
        - title: Example contract PDF
          content: '{{BASE64_PDF}}'
    SimplePDFdocumentupload200:
      title: SimplePDFdocumentupload200
      required:
        - id
        - title
        - content_type
    ...
    SignerIdentityData3:
      ...
      examples:
        - email_address: single-signer@skribble.com
    AddanindividualsignerRequest:
      title: AddanindividualsignerRequest
      required:
        - account_email
        - signer_identity_data
      type: object
      properties:
        ...
        signer_identity_data:
          allOf:
            - $ref: '#/components/schemas/SignerIdentityData3'
            - {}
      examples:
        - account_email: single-signer@skribble.com
          signer_identity_data:
            email_address: single-signer@skribble.com
    AddanattachmenttoasignaturerequestRequest:
      title: AddanattachmenttoasignaturerequestRequest
      required:
        - filename
        - content_type
        - content
      ...
      examples:
        - filename: some_attachment_with_somename.pdf
          content_type: application/pdf
          content: '{{BASE64_PDF}}'
    Addaunsupportedattachmenttype:
      title: Addaunsupportedattachmenttype
      required:
        - type
        - status
        - message
      ...
      examples:
        - type: https://api.skribble.com/problem/problem-with-message
          ...
          method: POST
          path: /v2/signature-requests/attachments
    WithdrawasignaturerequestRequest:
      title: WithdrawasignaturerequestRequest
      required:
        - message
      type: object
      properties:
      ...
      examples:
        - position:
          ...
          image:
            content_type: image/png
            content: '{{BASE64_PNG}}'
    SealadocumentRequest:
      title: SealadocumentRequest
      required:
        - content
        - visual_signature
      type: object
      properties:
        ...
        visual_signature:
          allOf:
            - $ref: '#/components/schemas/VisualSignature2'
            - {}
      examples:
        - content: '{{BASE64_PDF}}'
          visual_signature:
    ...
    Sealadocument200:
      ...
      examples:
        - document_id: e4cde459-6e63-0095-10b8-55b39ec39f46
    CreateSend-ToobjectRequest:
      title: CreateSend-ToobjectRequest
      required:
        - title
        - content
      type: object
    ...
    Ses:
      ...
      examples:
        - any: SES
    Getauserssignaturequalities:
      title: Getauserssignaturequalities
      required:
        - qes
        - aes_minimal
        - aes
      ...
      properties:
        ...
        aes_minimal:
          allOf:
            - $ref: '#/components/schemas/AesMinimal'
            - {}
        aes:
          allOf:
      ...
      examples:
        - qes:
          ...
          ses:
            any: SES
    Getthelistofcallbacksforasignaturerequest:
      title: Getthelistofcallbacksforasignaturerequest
      required:
